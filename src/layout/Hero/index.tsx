  ...
  return (
    <section className="flex bg-gradient-to-b from-slate-700/50 to-Coklat min-h-[100vh]  md:min-h-[60vh] bg-opacity-50 bg-cover lg:min-h-[100vh]">
      ...
      >
        ...
        <p className="container px-4 border-2 border-black bg-Brown2  rounded-3xl font-semibold w-[340px] sm:w-[350px] md:w-[650px] lg:w-[750px] text-Yellow text-lg md:text-lg ">
